...
import { Settings, AlertCircle, LogOut, LayoutGrid } from 'lucide-react'
      ...
      <div className="flex h-full flex-col">
        ...
        >
          ...
          <div className={cn(
            ...
            <div className={cn(
              "flex items-center gap-2 text-blue-500 transition-all duration-300",
              ...
              <Tooltip key={item.href}>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      "flex items-center w-full h-10 gap-3 hover:bg-gray-100/80 transition-colors text-gray-700",
